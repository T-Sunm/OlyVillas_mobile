...
const DropdownItems = ({ item, index, isExpanded, dropdownItemsCount }) => {
    ...
    const collapsedBackgroundColor = Color(expandedBackgroundColor).darken(index * 0.05).hex();
    ...
    const rStyle = useAnimatedStyle(() => {
        return {
            ...
            transform: [
                ...
                {
                    translateY: isExpanded.value ? fullDropDownHeight / 1.5 : fullDropDownHeight / 2 + 205
                },
    ...
    return (
        ...
        >
            <View style={styles.container}>
                <Animated.View style={[isHeader ? styles.iconContainerHeader : styles.iconContainer, rLeftIconOpacityStyle, {
                    left: 15
                }]}>
                    {item.icon}
                </Animated.View>
                ...
                <Animated.View style={[isHeader ? styles.iconContainerHeader : styles.iconContainer, rHeaderArrowIconStyle, {
                    right: 15
                }]}>
